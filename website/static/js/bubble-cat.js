bubbleCanvas = document.getElementById("bubbleChart").getContext("2d");
...
$.getJSON(dataJson, function(data) {
	...
	for (var l = 0; l < pageNamesUnique.length; l++) {
		...
		bubbleNames.push(nameObj);
	}

	for (n = 0; n < jsonData.length; n++) {
		var object = {label: bubbleNames[n], data: [jsonData[n]], backgroundColor: bgColors[n], borderColor: borderColors[n], hoverRadius: 5};
